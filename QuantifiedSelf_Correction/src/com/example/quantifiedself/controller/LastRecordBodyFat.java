...
public class LastRecordBodyFat extends DateFormat {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String strValue = Integer.toString(q.getBodyFatList().getLast().getValue());
		editValue.setText(strValue);
		editTime.setText(transformDate2(q.getBodyFatList().getLast().getTime()));
		...
		btnSave.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Date time = transformDate(editTime.getText().toString().trim(),LastRecordBodyFat.this);
				
				q.getBodyFatList().getLast().setValue(value);
				q.getBodyFatList().getLast().setTime(time);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.last_record_body_fat, menu);
		return true;
	}
