...
public class LastRecordHeartRate extends DateFormat {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String strValue = Integer.toString(q.getHeartRateList().getLast().getValue());
		editValue.setText(strValue);
		editTime.setText(transformDate2(q.getHeartRateList().getLast().getTime()));
		...
		btnSave.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Date time = transformDate(editTime.getText().toString().trim(),LastRecordHeartRate.this);
				
				q.getHeartRateList().getLast().setValue(value);
				q.getHeartRateList().getLast().setTime(time);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.last_record_heart_rate, menu);
		return true;
	}
