...
public class HeartRateNew extends DateFormat {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnSave.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Date time = transformDate(editTime.getText().toString().trim(), HeartRateNew.this);
				HeartRate hr = new HeartRate(value,"bpm",time);
